  ...
  <div class="container py-2 h-100">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col col-xl-6 w-50">
        <div class="card justify-content-center" style="border-radius: 1rem; background-color: #1F1F1F; width: 546px; height: 500px;">
          <div class="row g-0">
              ...
              <div class="card-body p-2 p-lg-5 text-black">
                ...
                <h1 class="text-center mb-5">Reset Password</h1>
                  ...
                  <div class="pt-1 text-center">
                    <button class="btn btn-dark btn-lg rounded-pill" type="button" style="background-color: #113250; width: 170px; height: 50px;">Lanjut</button>
                  </div>
                </form>
