        ...
        <div class="row">
            ...
            <div class="col-5 border rounded" style="height:100%">
                <div class="m-3 mt-4">
                    ...
                    <button type="button" class="btn btn-dark btn-lg rounded-pill mt-3" style="background-color: #113250; color: #FFFFFF; font-weight: 500; text-align: center; width: 100%;" data-toggle="modal" data-target="#exampleModal">
                    Saya sudah membayar
                    </button>
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="index.php?p=filmsaya"><button type="button" class="btn btn-primary">Next</button></a>
                        </div>
                        </div>
                    </div>
                    </div>
