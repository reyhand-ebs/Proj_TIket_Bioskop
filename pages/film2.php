    ...
    <div class="container mt-5 mb-5">
        <div class="row">
            ...
            <div class="col-6">
                ...
                <a href="index.php?p=wishlist"><button class="btn btn-dark btn-lg rounded-pill" style="background-color: #FFFFFF; color: #113250; font-weight: 500; text-align: center; width: 130px;">+ Wishlist</button></a>
                <a href="index.php?p=payment"><button class="btn btn-dark btn-lg rounded-pill" style="background-color: #113250; color: #FFFFFF; font-weight: 500; text-align: center; width: 130px;">Beli Tiket</button></a>
            </div>
        </div>
        <div class="row">
