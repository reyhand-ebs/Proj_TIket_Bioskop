...
(93, 'Ryan Potter', 'Russell Crowe.jpg'),
(94, 'Scott Adsit', 'Daniel Zovatto.jpg'),
(95, 'Jamie Chung', 'Russell Crowe.jpg'),
(96, 'Tom Hanks', 'Russell Crowe.jpg'),
(97, 'Mariana Treviño', 'Russell Crowe.jpg'),
(98, 'Rachel Keller', 'Halle Bailey.jpg');
...
CREATE TABLE IF NOT EXISTS `film` (
  ...
  `director_film` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `writer_film` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `durasi_film` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `trailer_film` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `harga_film` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `film` (`filmid`, `poster_film`, `judul_film`, `detail_film`, `rilis_film`, `rating_film`, `director_film`, `writer_film`, `durasi_film`, `trailer_film`, `harga_film`, `file_film`, `tanggal_upload`) VALUES
(0, 'Guardians of the Galaxy Vol. 3.jpg', 'Guardians of the Galaxy Vol. 3', 'Still reeling from the loss of Gamora, Peter Quill rallies his team to defend the universe and one of their own - a mission that could mean the end of the Guardians if not successful.', '2023-05-03', '8,3', 'James Gunn', 'James Gunn', '150', 'https://www.youtube.com/embed/JqcncLPi9zw', '20000', '', '2023-06-03'),
(1, 'Fast X.jpg', 'Fast X', 'The end of an era for the Fast and Furious Saga, a global franchise that has captivated audiences for three decades. Dom Toretto and his family, who have overcome countless obstacles, now face their most formidable adversary yet—a vengeful threat fro', '2023-05-17', '6,4', 'Louis Leterrier', 'James Gunn', '150', 'https://www.youtube.com/embed/eoOaKN4qCKw', '18000', '', '2023-06-03'),
(2, 'Evil Dead Rise.jpg', 'Evil Dead Rise', 'Moving the action out of the woods and into the city, \"Evil Dead Rise\" tells a twisted tale of two estranged sisters, played by Sutherland and Sullivan, whose reunion is cut short by the rise of flesh possessing demons, thrusting them into a primal b', '2023-04-05', '7,5', 'Ben Affleck', 'Alex Convery', '111', 'https://www.youtube.com/embed/BqQNO7BzN08', '14000', '', '2023-06-03'),
(3, 'Air.jpg', 'Air', 'The movie explores how Nike\'s basketball shoe division was struggling in 1984 due to low sales, and how the company\'s Marketing VP Rob Strasser and CEO Phil Knight tasked basketball talent scout Sonny Vaccaro to find a new spokesperson for their shoe', '2023-04-05', '7,5', 'Ben Affleck', 'Alex Convery', '111', 'https://www.youtube.com/embed/Euy4Yu6B3nU', '12000', '', '2023-06-03'),
(4, 'The Super Mario Bros. Movie.jpg', 'The Super Mario Bros. Movie', 'A Brooklyn plumber named Mario travels through the Mushroom Kingdom with a princess named Peach and an anthropomorphic mushroom named Toad to find Mario\'s brother, Luigi, and to save the world from a ruthless fire-breathing Koopa named Bowser.', '2023-04-05', '7,2', 'Aaron Horvath, Michael Jelenic, Pierre L', 'Matthew Fogel', '92', 'https://www.youtube.com/embed/TnGl01FkMMo', '15000', '', '2023-06-03'),
(5, 'Avatar The Way of Water.jpg', 'Avatar: The Way of Water', 'Several years after the Na\'vi repelled the RDA invasion Jake Sully and his family are living on Pandora. Things seem peaceful but the RDA has other plans, invading and capturing Pandora. Sully forms a guerrilla group to try to expel the invaders.', '2022-12-14', '7,7', 'James Cameron', 'James Cameron, Rick Jaffa, Amanda Silver', '143', 'https://www.youtube.com/embed/o5F8MOz_IDw', '20000', '', '2023-06-03'),
(6, 'Aquaman.jpg', 'Aquaman', 'Born upon the shores of the surface world, Arthur Curry (Jason Momoa) discovers that he is only half human, with the other half of his blood being of Atlanteean descent, thus making him the rightful heir to the throne of the undersea kingdom of Atlan', '2018-12-12', '6,8', 'James Wan', 'David Leslie Johnson-McGoldrick, Will Be', '143', 'https://www.youtube.com/embed/2wcj6SrX4zw', '15000', '', '2023-06-03'),
(7, 'Avengers Endgame.jpg', 'Avengers: Endgame', 'After the devastating events of Avengers: Infinity War (2018), the universe is in ruins due to the efforts of the Mad Titan, Thanos. With the help of remaining allies, the Avengers must assemble once more in order to undo Thanos\'s actions and undo th', '2019-04-24', '8,4', 'Anthony Russo, Joe Russo', 'Christopher Markus, Stephen McFeely, Sta', '181', 'https://www.youtube.com/embed/TcMBFSGVi1c', '16000', '', '2023-06-03'),
(8, 'Spider-Man No Way Home.jpg', 'Spider-Man: No Way Home', 'Peter Parker\'s secret identity is revealed to the entire world. Desperate for help, Peter turns to Doctor Strange to make the world forget that he is Spider-Man. The spell goes horribly wrong and shatters the multiverse, bringing in monstrous villain', '2021-12-15', '8,2', 'Jon Watts', 'Chris McKenna, Erik Sommers, Stan Lee', '148', 'https://www.youtube.com/embed/JfVOs4VSpmA', '15000', '', '2023-06-03'),
(9, 'Mencuri Raden Saleh.jpg', 'Mencuri Raden Saleh', 'Pencurian terbesar abad ini tinggal menghitung hari menjelang tanggal eksekusinya. Komplotan sudah lengkap dan siap menjalankan misi untuk mencuri lukisan sang maestro, Raden Saleh, yang berjudul Penangkapan Diponegoro. Pemalsuan, peretasan, pertarun', '2022-08-25', '7,3', 'Angga Dwimas Sasongko', 'Husein M. Atmodjo, Angga Dwimas Sasongko', '154', 'https://www.youtube.com/embed/DN3sRz_veBU', '15000', '', '2023-06-03'),
(10, 'Penyalin Cahaya.jpg', 'Penyalin Cahaya', 'Penyalin Cahaya berkisah soal Sur (Shenina Cinnamon) yang kehilangan beasiswa karena dianggap mencemarkan nama baik fakultas dan melanggar aturan beasiswa usai swafoto dirinya kala mabuk tersebar.', '2021-10-08', '6,8', 'Wregas Bhanuteja', 'Wregas Bhanuteja', '130', 'https://www.youtube.com/embed/jiAcriibQwU', '10000', '', '2023-06-03'),
(11, 'Train to Busan.jpg', 'Train to Busan', 'Seok-woo dan putrinya yang berulang tahun pergi ke Busan dengan kereta untuk menemui istrinya. Tapi perjalanan tersebut berubah menjadi mimpi buruk kala mereka terjebak di tengah-tengah wabah zombie.', '2016-07-01', '7,6', 'Yeon Sang-ho', 'Yeon Sang-ho', '118', 'https://www.youtube.com/embed/pyWuHv2-Abk', '12000', '', '2023-06-03'),
...
DROP TABLE IF EXISTS `film_wishlist`;
CREATE TABLE IF NOT EXISTS `film_wishlist` (
  `film_id` int NOT NULL,
  `userid` int NOT NULL,
  KEY `filmid_fkfw_1` (`film_id`),
  KEY `userid_fkfw_2` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
